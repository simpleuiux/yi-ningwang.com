    ...
    <Layout title={siteTitle}>
      ...
      <article className="post-content page-template no-image">
        <div className="post-content-body">
          <h1 id="about-me-titles"><br />
            A design, psychology, and travel enthusiast who {" "}
            <a href="https://github.com/simpleuiux">
              code</a>{" "} her own ideas.
          </h1>
          <br /><br /><br /><br /><br />
          ...
          <div className="row">
            ...
            <div className="col-6">
              ...
              >
                <div class="skill">
                  <h5>I'm currently a UX designer based in Vancouver. <br />
                  I have a passionate, curious and persistent mind.
                  I am very keen on implementing new experiences through design, writing and coding.
                  </h5>
          ...
          <div className="row">
            <div className="col-6">
              ...
              >
                <div class="skill">
                  <div class="skill-icon">
                    <svg width="60px" height="50px" viewBox="0 0 60 60" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" id="skill-ui-icon">
                      <defs></defs>
                      <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="light-bulb" fill-rule="nonzero" fill="#F0BF60">
                          ...
                          <rect class="bulb-ray" id="bulb-ray1" x="0" y="27.5755102" width="6.39183673" height="2.55918367" fill="#F0BF60"></rect>
                          <polygon class="bulb-ray" id="bulb-ray2" points="9.68571429 7.49387755 7.84897959 9.31836735 12.3183673 13.6163265 14.1428571 11.7918367" fill="#F0BF60"></polygon>
                          <rect class="bulb-ray" id="bulb-ray3" x="28.6897959" y="0" width="2.60816327" height="6.12244898" fill="#F0BF60"></rect>
                          <polygon class="bulb-ray" id="bulb-ray4" points="45.8081633 11.8040816 47.6326531 13.6285714 52.1020408 9.33061224 50.2653061 7.50612245" fill="#F0BF60"></polygon>
                          <rect class="bulb-ray" id="bulb-ray5" x="53.6081633" y="27.5755102" width="6.39183673" height="2.55918367" fill="#F0BF60"></rect>
                        </g>
                      </g>
                    </svg>
                  </div>
                  <h3>UX Designer</h3>
                  <p>I'm a UX designer with 3+ years of experience. Currently a UX / UI designer at Red Academy in Vancouver.</p>
                </div>
            ...
            <div className="col-6">
              ...
              >
                <div class="skill">
                  <div class="skill-icon">
                    <svg width="60px" height="50px" viewBox="0 0 76 50" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns xlink="http://www.w3.org/1999/xlink" id="skill-code-icon">
                      <defs></defs>
                      <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <path d="M21.963,8.904 C21.448,8.256 20.507,8.146 19.856,8.662 L0.643,23.901 C0.285,24.185 0.076,24.618 0.076,25.076 C0.076,25.534 0.285,25.967 0.643,26.251 L19.855,41.49 C20.131,41.709 20.46,41.815 20.787,41.815 C21.229,41.815 21.667,41.621 21.963,41.248 C22.479,40.599 22.369,39.655 21.721,39.141 L3.989,25.076 L21.72,11.012 C22.369,10.497 22.479,9.554 21.963,8.904 Z" id="code-left" fill="#31ABF4"></path>
                        <path d="M75.357,23.901 L56.145,8.662 C55.494,8.146 54.551,8.256 54.038,8.904 C53.522,9.553 53.632,10.497 54.28,11.011 L72.011,25.075 L54.279,39.141 C53.631,39.656 53.521,40.599 54.037,41.248 C54.333,41.621 54.77,41.815 55.213,41.815 C55.539,41.815 55.868,41.709 56.145,41.49 L75.358,26.251 C75.716,25.967 75.925,25.534 75.925,25.076 C75.925,24.618 75.716,24.186 75.357,23.901 Z" id="code-right" fill="#31ABF4"></path>
                        <path d="M47.013,0.308 C46.239,0.022 45.375,0.425 45.091,1.204 L28.091,47.923 C27.808,48.701 28.209,49.562 28.987,49.845 C29.156,49.908 29.329,49.936 29.5,49.936 C30.112,49.936 30.688,49.558 30.909,48.949 L47.909,2.23 C48.192,1.451 47.791,0.591 47.013,0.308 Z" id="Path" fill="#31ABF4"></path>
                      </g>
                    </svg>
                  </div>
                  <h3>Front-End Developer</h3>
                  <p>I like to code my own designs. I apply my designs with modern HTML, (S)CSS and basic Javascript.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-6">
              ...
              >
                <div class="skill">
                  <div class="skill-icon">
                    <svg width="60px" height="50px" viewBox="0 0 49 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns xlink="http://www.w3.org/1999/xlink" id="skill-speaker-icon">
                      <defs></defs>
                      <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="noun_690159_cc" transform="translate(-1.000000, -7.000000)" fill-rule="nonzero" fill="#F5AF6F">
                  ...
                  <h3>Presenter</h3>
                  <p>I present at hackathons and conferences about UX / UI design, business plan and more.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <p>
            I started my career as an international journalist and market researcher. I have travelled to 40+ countries and collaborated with people from
            North America, Africa, Europe to Asia.
          </p>
          <p>
            In 2015, I worked for UBS and dived into UX world.
            Since then, I have been growing from UX researcher to UX / UI designer.
            I have provided systematic and precise researches and designs for industries
            from <b>Fintech, Banking, NGO, Healthcare, to Data Analysis</b>.
          </p>
          <p>Co-founder of a Canadian-based Tech design studio - {" "}
            <a href="https://sassy.technology">
              SassyTech
            </a>{" "}.​​​​​​​</p>
          <p>
            ...
            2014 - 2016 &nbsp; National Chiao Tung University - Global MBA <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            (World's Top 100 in entrepreneurship)<br />
            2006 - 2010 &nbsp; National Cheng Chi University  - Media and Communication <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            (Top 1 Nation-wide)<br />
          </p>
