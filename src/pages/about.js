      ...
      <article className="post-content page-template no-image">
        <div className="post-content-body">
          ...
          <h1 id="about-me-titles">
            A human behavior, design and travel enthusiast who likes to {" "}
            <a href="https://github.com/simpleuiux">
              code</a>{" "} her own ideas.
          </h1>
          <br /><br /><br /><br />

          <h5 id="about-me-titles"><br />
            What I am reading right now - <br />
                  ...
                  <div class="skill-icon">
                    <svg width="60px" height="60px" viewBox="0 0 60 60" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" id="skill-ui-icon">
                      ...
                      <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="light-bulb" fill-rule="nonzero" fill="#F8FE2E">
                          ...
                          <rect class="bulb-ray" id="bulb-ray1" x="0" y="27.5755102" width="6.39183673" height="2.55918367" fill="#F8FE2E"></rect>
                          <polygon class="bulb-ray" id="bulb-ray2" points="9.68571429 7.49387755 7.84897959 9.31836735 12.3183673 13.6163265 14.1428571 11.7918367" fill="#F8FE2E"></polygon>
                          <rect class="bulb-ray" id="bulb-ray3" x="28.6897959" y="0" width="2.60816327" height="6.12244898" fill="#F8FE2E"></rect>
                          <polygon class="bulb-ray" id="bulb-ray4" points="45.8081633 11.8040816 47.6326531 13.6285714 52.1020408 9.33061224 50.2653061 7.50612245" fill="#F8FE2E"></polygon>
                          <rect class="bulb-ray" id="bulb-ray5" x="53.6081633" y="27.5755102" width="6.39183673" height="2.55918367" fill="#F8FE2E"></rect>
                        </g>
                      </g>
                    </svg>
                  </div>
          ...
          <p>
            ...
            with interviewing experiences across 20+ countries across
            North America, Africa, Europe and Asia. Helped start-ups and MNCs created 5+ business plans.
          </p>
          <p>
