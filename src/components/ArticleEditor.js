    ...
    <div className="min-h-screen" style={{ backgroundColor: "#f8f9fa" }}>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border mb-6" style={{ borderColor: "#e5e7eb" }}>
          <div className="px-6 py-5 border-b" style={{ borderColor: "#e5e7eb", backgroundColor: "#fafafa" }}>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-lg text-gray-600">
                  {existingSlug ? "Update your article content" : "Create a new portfolio article"}
                </p>
              </div>
              <Link
                to="/admin"
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border overflow-hidden" style={{ borderColor: "#e5e7eb" }}>
          <div className="px-6 py-6 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onFocus={(e) => !existingSlug && (e.target.style.borderColor = "#26a8ed")}
                onBlur={(e) => e.target.style.borderColor = "#d1d5db"}
          ...
          {/* Footer Actions */}
          <div className="px-6 py-4 bg-gray-50 border-t flex items-center justify-end space-x-3" style={{ borderColor: "#e5e7eb" }}>
            <Link
              to="/admin"
